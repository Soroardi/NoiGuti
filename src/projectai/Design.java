...
//
//        Insets insets1 = panel2.getInsets();
//
//        Dimension size1 = panel2.getPreferredSize();
//        panel2.setBounds(700 + insets1.left, insets1.top,
//                size1.width + 150, size1.height + 700);
//        frame.add(panel2);
//        panel2.setBackground(Color.white);
//        //JButton xbtn = new JButton("X Move");
//        panel2.add(xbtn);
//        size1 = xbtn.getPreferredSize();
//        xbtn.setBounds(20 + insets1.left, 150 + insets1.top,
//                size1.width + 20, size1.height + 20);
//        //xbtn.setBackground(Color.RED);
//
//        // JButton ybtn = new JButton("Y Move");
//        panel2.add(ybtn);
//        size1 = ybtn.getPreferredSize();
//        ybtn.setBounds(120 + insets1.left, 150 + insets1.top,
//                size1.width + 20, size1.height + 20);
